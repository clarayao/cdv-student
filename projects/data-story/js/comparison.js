let comW = d3.select(".comparison-viz").style("width").split("px").shift();
let comH = window.innerHeight;
let comXpadding = 40;
let comYpadding = 100;
let comJPadding = 50;
...
continentAxisGroup.append("text")
                    ...
                    .style("text-anchor", "middle")
                    .attr("fill", "white")
                    .attr("font-size", comW/70+"px")
;
continentAxisGroup.append("text")
                    .text("Europe")
                    .attr("x", comW/2)
                    .attr("y", continentScale("Europe")+continentScale.bandwidth()/2)
                    .style("text-anchor", "middle")
                    .attr("fill", "white")
                    .attr("font-size", comW/70+"px")
;
continentAxisGroup.append("text")
                    .text("Africa")
                    .attr("x", comW/2)
                    .attr("y", continentScale("Africa")+continentScale.bandwidth()/2)
                    .style("text-anchor", "middle")
                    .attr("fill", "white")
                    .attr("font-size", comW/70+"px")
;
continentAxisGroup.append("text")
                    .text("Oceania")
                    .attr("x", comW/2)
                    .attr("y", continentScale("Oceania")+continentScale.bandwidth()/2)
                    .style("text-anchor", "middle")
                    .attr("fill", "white")
                    .attr("font-size", comW/70+"px")
;
continentAxisGroup.append("text")
                    .text("Anglo America")
                    .attr("x", comW/2)
                    .attr("y", continentScale("Anglo America")+continentScale.bandwidth()/2)
                    .style("text-anchor", "middle")
                    .attr("fill", "white")
                    .attr("font-size", comW/70+"px")
;
continentAxisGroup.append("text")
                    .text("Latin America")
                    .attr("x", comW/2)
                    .attr("y", continentScale("Latin America")+continentScale.bandwidth()/2)
                    .style("text-anchor", "middle")
                    .attr("fill", "white")
                    .attr("font-size", comW/70+"px")
;

...
function cdvTextWrap(w, h){
    h=h==undefined?1:h;
    return d3.textwrap().bounds({height: h, width: w}).method('tspans');
}
// and (2) wrapped statements in Number() functions on line 61.
...
!(function (t, e) {
    ...
    "use strict";
    var n, o, r, i, d, u, p, a;
    (n = "undefined" == typeof SVGForeignObjectElement ? "tspans" : "foreignobject"),
        (o = function (t) {
            var n, o;
            return (
                (o = "function" == typeof t),
                "object" != typeof t || t.nodeType
                    ? !!(t instanceof e.selection || t.nodeType || o || n) || (console.error("invalid bounds specified for text wrapping"), !1)
                    : !(!t.height || !t.width) || (console.error("text wrapping bounds must specify height and width"), !1)
            );
        }),
        (r = function (t) {
            var e, n, o, r;
        ...
        (d = function (t, e) {
            var n;
            return (n = { height: t.height - 2 * e, width: t.width - 2 * e });
        }),
        (u = function (t, e) {
            var n;
            return (n = d(r(t), i(e)));
        ...
        (p = {}),
        (p.foreignobject = function (t, n, o) {
            var r, i, d, u;
            return (
                (r = t.text()),
                (i = e.select(t.node().parentNode)),
                t.remove(),
                (d = i.append("foreignObject")),
                d.attr("requiredFeatures", "http://www.w3.org/TR/SVG11/feature#Extensibility").attr("width", n.width).attr("height", n.height),
                "number" == typeof o && d.attr("x", o).attr("y", o),
                (u = d.append("xhtml:div")),
                u.style("height", n.height).style("width", n.width).html(r),
                u
            );
        }),
        (p.tspans = function (t, e, n) {
            var o, r, i, d, u, p;
            for (o = t.text().split(" ").reverse(), t.text(""), u = t.append("tspan"), u.attr("dx", 0).attr("dy", 0), d = 0; o.length > 0; )
                (r = o.pop()),
                    u.text(u.text() + " " + r),
                    (i = u.node().getComputedTextLength() || 0),
                    i > e.width && ((p = u.text().split(" ").slice(0, -1).join(" ")), u.text(p), (d = u.node().getComputedTextLength() * -1), (u = t.append("tspan")), u.attr("dx", d).attr("dy", "1em").text(r));
            "number" == typeof n && t.attr("y", Number(t.attr("y")) + n).attr("x", Number(t.attr("x")) + n);
        }),
        (a = function () {
            var t, r, d;
            return (
